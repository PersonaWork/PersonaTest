    ...
    return (
        <div className="block no-underline relative group/card">
            <Link href={`/character/${character.slug}`} className="block no-underline">
                <Card className="h-full group cursor-pointer overflow-hidden shimmer-border hover-tilt" padding="none">
                    {/* Image Area */}
                    <div className="relative h-48 bg-gradient-to-br from-indigo-900/40 via-purple-900/30 to-pink-900/20 overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="relative">
                                <div className="w-28 h-28 rounded-full bg-slate-800/80 border-4 border-slate-700 overflow-hidden shadow-2xl group-hover:scale-110 group-hover:border-indigo-500/50 transition-all duration-300 relative avatar-ring-pulse">
            ...
            <div className="absolute bottom-4 right-4 opacity-0 group-hover/card:opacity-100 transition-all duration-200 translate-y-1 group-hover/card:translate-y-0 z-10">
                <Link
                    ...
                    className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-bold shadow-lg shadow-indigo-500/30 transition-all hover:shadow-indigo-500/50 no-underline press-effect"
