...
// In Prisma 7, to override datasource in constructor:
const prisma = new PrismaClient({
    // No options here, it will pick up DATABASE_URL from process.env because of dotenv/config
});
    ...
    const luna = await prisma.character.upsert({
        ...
        create: {
            ...
            personality: {
                ...
                voiceId: 'zY0NiG61kNwoIJvKtYe1', // Luna's Voice ID
    ...
    const jax = await prisma.character.upsert({
        ...
        create: {
            ...
            personality: {
                ...
                voiceId: 'uUJ3WiXG3FVW4fbdcG2s', // Jax's Voice ID
    ...
    const nova = await prisma.character.upsert({
        ...
        create: {
            ...
            personality: {
                ...
                voiceId: 'IO6iOM9shwUY9mAN0sMi', // Nova's Voice ID
