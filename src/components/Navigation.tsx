            ...
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  {link.label}
                  {active && (
                    <div className="absolute -bottom-[13px] left-1/2 -translate-x-1/2 w-8 h-[2px] rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 nav-active-pill" />
                  )}
                </Link>
              );
            })}
            ...
            <div className="hidden sm:flex items-center gap-2">
              {isLoading ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link href="/signup">
                    <button className="group/btn relative px-5 py-2 rounded-xl text-[13px] font-bold text-white overflow-hidden press-effect">
